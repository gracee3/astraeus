...
**Status:** Active research software. Core artifact and validation contracts are implemented, while interfaces remain pre-1.0. GitHub Actions is intentionally disabled during rapid feature development; published checkpoints rely on documented local acceptance.
